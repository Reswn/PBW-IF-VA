...
class TodoModel {
     ...
     * Membuat todo baru
     * 
     * Metode ini akan membuat todo baru dengan nama dan tugas yang diberikan
     ...
     * 
     * @param string $nama Nama dari todo
     * @param string $task Teks dari tugas
     * @return boolean
     */
    public function createTodo($nama, $task) {
        $query = "INSERT INTO " . $this->table_name . " (nama, task) VALUES (:nama, :task)";
        $stmt = $this->conn->prepare($query);
     ...
     * akan mengembalikan nilai true, jika gagal maka metode ini
